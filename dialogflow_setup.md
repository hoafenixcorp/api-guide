...
### 2.2 Thiết lập các Flow còn lại

Dựa trên hướng dẫn cho MemberCodeVerification, chúng ta sẽ làm tương tự cho EventVerification hoặc những logic khác
Mình chỉ hướng dẫn cách để setup các flow theo tree format

Tạo EventVerification Flow và EventVerification Page

<img width="278" height="617" alt="Screenshot 2025-07-27 at 17 46 56" src="https://github.com/user-attachments/assets/662e01a3-5200-4a97-b46d-46e2093c3c26" />

Quay lại `Start Page` của MemberCodeVerification Flow
Ta sẽ thêm intent của event verification vào đây, và transition đến EventVerification Page
